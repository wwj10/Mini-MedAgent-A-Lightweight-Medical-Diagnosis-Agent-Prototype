...
backup_path = PROJECT_ROOT / "outputs" / "memory" / "medical_memory_backup_before_retrieval_ablation.json"
...
def run_condition(
    ...
    print(f"memory_retrieval_mode = {memory_retrieval_mode}")
    print("=" * 100)

    output_dir = PROJECT_ROOT / "outputs" / "retrieval_ablation" / condition_name / "demo_transcripts"
...
conditions = [
    ...
    {
        "condition_name": "keyword_memory",
        "use_memory": True,
        "memory_mode": "all",
        "memory_retrieval_mode": "keyword",
    },
    {
        "condition_name": "embedding_memory",
        "use_memory": True,
        "memory_mode": "all",
...
for condition in conditions:
    ...
    rows = run_condition(
        ...
        memory_retrieval_mode=condition["memory_retrieval_mode"],
    )
...
case_result_path = result_dir / "retrieval_ablation_case_summary.csv"
condition_result_path = result_dir / "retrieval_ablation_condition_summary.csv"
